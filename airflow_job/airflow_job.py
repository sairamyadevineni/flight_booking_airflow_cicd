...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="us-central1-airflow-test-601a03c4-bucket")
    bq_project = Variable.get("bq_project", default_var="vivid-env-448816-c5")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "373888192341-compute@developer.gserviceaccount.com",
                "network_uri": "projects/vivid-env-448816-c5/global/networks/default",
                "subnetwork_uri": "projects/vivid-env-448816-c5/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="vivid-env-448816-c5",
        region="us-central1",
